...
queries = [
        ...
        ('folio_source_record.records', '/source-storage/records', 'cql.allRecords=1 sortby id'),
        ('folio_source_record.marc_records_lb', '/source-storage/source-records', 'cql.allRecords=1 sortby id', 0),
